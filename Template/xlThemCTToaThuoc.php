<?php
         ...
         //if(isset($_REQUEST["btnAdd"]))
          ...
          //Thêm vào bảng chitiettoathuoc
          $count=0;
          $matt = mysql_query("Select matoathuoc From toathuoc Where maphieukcb=$mp");
          while ($row_tt = mysql_fetch_array($matt))
          {
            $query_ct = "Insert Into chitiettoathuoc values (null,$row_tt[0], $mt, $sg, $tr, $ch, $to, $sl, '$gc' )";
          ...
          if (!$result_ct)
          {
      	 ...
      	 {
      	   echo "<form action='frmHienThiCapNhatCTToaThuoc.php' method='GET' id='frmXXL'>";
           echo "<table border='1'>";
             echo "<tr>" ;
